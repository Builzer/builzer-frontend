...
export default function ProjectDetailSetting() {
  const projectDefaultValue = useRecoilValue<projectDefaultInfo>(
    projectDefaultInfoState
  );
  const [projectBuildInfo, setProjectBuildInfo] =
    useRecoilState<projectBuildInfo>(projectBuildState);
  const resetProjectBuildInfo = useResetRecoilState(projectBuildState);
  const projectCollaborators = useRecoilValue<Array<selectItem>>(
    projectCollaboratorsState
  );
  ...
  const setSelectedProject =
    useSetRecoilState<projectInfoSimple>(selectedProjectState);
      ...
      >
        ...
        <div className="flex flex-col gap-5">
          ...
          <SelectLanguage
            ...
            setProjectBuildInfo={setProjectBuildInfo}
          />
        </div>
        <div className="flex flex-col gap-5">
        ...
        <div className="w-full flex flex-col gap-5 relative">
              ...
              <div className="w-1/2">
                ...
                >
                  <Input
                    ...
                    size="large"
                    placeholder="아이디"
                    onChange={(e) => handleDbId(e.target.value)}
                  />
                </Form.Item>
              </div>
              <div className="w-1/2">
                ...
                >
                  <Input.Password
                    ...
                    onChange={(e) => handleDbPw(e.target.value)}
                  />
                </Form.Item>
              </div>
            </div>
          ...
          {projectBuildInfo.projectInfo.projectPlan === "Lite" ? (
            <div>
              <div className="absolute z-10 top-12 w-[805px] h-[160px] bg-gray10 opacity-50 rounded-md"></div>
                ...
                <Popconfirm
                  ...
                  description={
                    <div className="w-[400px] mt-2">
                      PRO 버전으로 업그레이드 시 추가 서버 스펙 선택,
                      데이터베이스 설정이 가능합니다.
                      <br />
                      <p className="mt-4 font-medium">
                        ⚠️ 추가 크레딧이 부과될 수 있습니다.
                      </p>
                    </div>
                  }
                  onConfirm={confirm}
                  ...
                  cancelText="취소"
                >
                  <Button className="ml-[41%] bg-black mt-2" type="primary">
                    PRO로 업그레이드
                  </Button>
                </Popconfirm>
              </div>
