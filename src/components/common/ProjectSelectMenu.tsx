...
export default function ProjectSelectMenu() {
  ...
  return (
    <div className="absolute ml-[-50px] mt-2">
      <div
        className="relative z-20 cursor-pointer px-3 text-white w-[200px] h-[40px] bg-gray13 rounded-md font-light"
      ...
      >
        {selectProject.projectName === "" ? (
          ...
          <div className="flex flex-row justify-between">
            <p className="text-xl justify-center py-2">
              {selectProject.projectName}
            </p>
            <span className="py-2">
      ...
      {isMenuShow && (
        <div className="w-[200px] h-[300px] font-light bg-white relative z-20 mt-1 rounded-md p-2 shadow-lg">
